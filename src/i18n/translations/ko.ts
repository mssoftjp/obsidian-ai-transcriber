...
const ko: TranslationKeys = {
	...
	settings: {
		...
		model: {
			...
			gptTranscribeDesc: '최신 고정확도 모델(권장)',
			gptTranscribeDefault: 'GPT Transcribe(권장)',
			whisper: 'Whisper-1',
			whisperDesc: '타임스탬프가 필요할 때 사용',
			gpt4o: 'GPT-4o Transcribe',
			gpt4oDesc: '기존 고정확도 모델',
			gpt4oMini: 'GPT-4o Mini Transcribe',
			gpt4oMiniDesc: '가장 저렴한 GPT 전사 옵션',
	...
	notices: {
		...
		vadDisabledFallback: '로컬 VAD 모듈을 사용할 수 없어 무음을 제거하지 않고 계속 처리합니다.',
	...
	modal: {
		...
		transcription: {
			...
			additionalProcessingCostNote: '이 금액은 전사 비용만 포함합니다. AI 후처리는 추가 API 요청을 사용하므로 예상 비용을 초과할 수 있습니다.',
			timeRange: '시간 범위',
	...
	errors: {
		...
		notices: {
			...
			supportedFormats: '지원 형식: 오디오 (MP3, WAV, M4A, FLAC, AAC, OGG, WMA Standard), 비디오 (MP4, M4V, MOV, AVI, MKV, WebM)',
