...
const en: TranslationKeys = {
	...
	settings: {
		...
		model: {
			...
			gptTranscribeDesc: 'Latest high-accuracy model (recommended)',
			gptTranscribeDefault: 'GPT Transcribe (recommended)',
			whisper: 'Whisper-1',
			whisperDesc: 'Use when timestamps are needed',
			gpt4o: 'GPT-4o transcribe',
			gpt4oDesc: 'Existing high-accuracy model',
			gpt4oMini: 'GPT-4o mini transcribe',
			gpt4oMiniDesc: 'Lowest-cost GPT transcription option',
	...
	modal: {
		...
		transcription: {
			...
			additionalProcessingCostNote: 'This amount covers transcription only. AI post-processing uses additional API requests and may exceed the estimate.',
	...
	errors: {
		...
		notices: {
			...
			supportedFormats: 'Supported formats include audio (mp3, wav, m4a, flac, aac, ogg, wma standard) and video (mp4, m4v, mov, avi, mkv, webm).',
