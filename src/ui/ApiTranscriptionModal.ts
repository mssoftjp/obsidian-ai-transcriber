import { Modal, Notice, TFolder, Platform, Setting, getLanguage, ButtonComponent, normalizePath } from 'obsidian';
	...
	private async insertTranscription(transcription: string, modelUsed?: string) {
		...
		this.logger.debug('Generated filename', { fileName });
			...
			default:
				...
				try {
					await this.app.vault.process(createdFile, () => formattedTranscription);
